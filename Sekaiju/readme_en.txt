/******************************************************************************/
/*                                                                            */
/*  Sekaiju5.9  read me first                             (C)2002-2020  kuzu  */
/*                                                                            */
/******************************************************************************/

Thank you for downloading Sekaiju5.9. This file includes basic information and
...
(1) Please extract "Sekaiju5.9.zip" on your hard disk.
...
(1) Delete "Sekaiju5.9" folder on "explorer" or "my computer".
 ...
 * SekaijuJpn.dll       (c)2020 kuzu / OpenMIDIProject  License = GNU LGPL
 * SekaijuEnu.dll       (c)2020 kuzu / OpenMIDIProject  License = GNU LGPL
 * SekaijuChs.dll       (c)2020 kuzu / OpenMIDIProject  License = GNU LGPL
 * MIDIIO.dll           (c)2020 kuzu / OpenMIDIProject  License = GNU LGPL
 * MIDIData.dll         (c)2020 kuzu / OpenMIDIProject  License = GNU LGPL
 ...
 * mfc90chs.dll         (c)2011 Microsoft Corporation  License = Proprietary
  ...
  !Warning! These dlls are shipped with Sekaiju5.9.
 ...
 * A bug that when loading abnormal meta event (e.g. length=0's port prefix), causes freezing is fixed.
 ...
 * MIDIDataLibrary is updated to 1.2.

...
void CPianoRollFrame::RecalcLayout (BOOL bNotify) {
	...
	CSize sizToolBar1 = m_wndToolBar1.CalcFixedLayout (FALSE, TRUE);
	m_lToolBar1Height = sizToolBar1.cy;
...
void CPianoRollFrame::OnHScroll (UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) {
	...
	if (pScrollBar == &m_wndTimeScroll) {
		...
		case SB_LINERIGHT:
			...
			break;
		case SB_PAGELEFT:
			lNewPos = m_lTimeScrollPos - m_lTimeZoom * 12;
			break;
		case SB_PAGERIGHT:
			lNewPos = m_lTimeScrollPos + m_lTimeZoom * 12;
			break;
...
void CPianoRollFrame::OnVScroll (UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) {
	...
	if (pScrollBar == &m_wndKeyScroll) {
		...
		switch (nSBCode) {
		case SB_LINEUP:
			lNewPos = m_lKeyScrollPos - m_lKeyZoom * 4;
			break;
		case SB_LINEDOWN:
			lNewPos = m_lKeyScrollPos + m_lKeyZoom * 4;
			break;
		...
		switch (nSBCode) {
		case SB_LINEUP:
			lNewPos = m_lVelScrollPos - m_lVelZoom * 5;
			break;
		case SB_LINEDOWN:
			lNewPos = m_lVelScrollPos + m_lVelZoom * 5;
			break;

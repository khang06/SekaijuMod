...
public:
	...
	CButton m_wndFillCheckBox;          // ツールバー上のフィルチェックボックス
	CButton m_wndTrimCheckBox;          // ツールバー上のトリムチェックボックス
...
protected:
	...
	afx_msg void OnMusicalScoreTie ();
	afx_msg void OnUpdateMusicalScoreTieUI (CCmdUI* pCmdUI);
	...
	afx_msg void OnFillCheckClicked ();
	afx_msg void OnTrimCheckClicked ();

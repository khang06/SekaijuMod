...
int CEventListFrame::OnCreate (LPCREATESTRUCT lpCreateStruct) {
	...
	// イベントトラックコンボボックスの作成
	m_wndToolBar1.SetButtonInfo (6, IDC_EVENTTRACKCOMBO, TBBS_SEPARATOR, 120);
	...
	// イベントタイムエディットの作成
	m_wndToolBar1.SetButtonInfo (8, IDC_EVENTTIMEEDIT, TBBS_SEPARATOR, 120);
	...
	// イベント種類コンボボックスの作成
	m_wndToolBar1.SetButtonInfo (10, IDC_EVENTKINDCOMBO, TBBS_SEPARATOR, 150);
	...
	// イベントチャンネルコンボボックスの作成
	m_wndToolBar1.SetButtonInfo (12, IDC_EVENTCHANNELCOMBO, TBBS_SEPARATOR, 60);

...
#define MIDIEVENT_AVOIDOUTPUT          0x00000008
...
public:
	...
	BOOL m_bLoopEnd;                    // loopEndに達したか(FF7方式)?
...
public:
	...
	MIDIEvent* m_pTempProgramChangeEvent; // 一時的なプログラムチェンジイベントへのポインタ
...
public:
	int m_nSALCurTrack;
	void* m_pSALForEachEventArray;
	int m_nSALForEachEventArrayNum;
...
public:
	...
	virtual void    TimeMIDIStatus (long lTargetTime, long lKeyShift, MIDIStatus* pTempMIDIStatus[]);
...
protected:
	...
	afx_msg void OnEditTempo ();
	afx_msg void OnUpdateEditTempoUI (CCmdUI* pCmdUI);
	...
	afx_msg void OnUpdateEditStrokeUI (CCmdUI* pCmdUI);
	
	afx_msg void OnEditInsertMeasure ();
	afx_msg void OnUpdateEditInsertMeasureUI (CCmdUI* pCmdUI);
	afx_msg void OnEditRemoveMeasure ();
	afx_msg void OnUpdateEditRemoveMeasureUI (CCmdUI* pCmdUI);

	afx_msg void OnEditSAL ();
	afx_msg void OnUpdateEditSALUI (CCmdUI* pCmdUI);
	afx_msg void OnEditTerminateSAL (); // 非表示,ESCキーで実行
	afx_msg void OnUpdateEditTerminateSALUI (CCmdUI* pCmdUI); // 非表示,ESCキーで実行
	...
	afx_msg void OnUpdatePopupShowTrackListUI (CCmdUI* pCmdUI);
	afx_msg void OnPopupShowPianoRoll ();
	afx_msg void OnUpdatePopupShowPianoRollUI (CCmdUI* pCmdUI);
	afx_msg void OnPopupShowEventList ();
	afx_msg void OnUpdatePopupShowEventListUI (CCmdUI* pCmdUI);
	afx_msg void OnPopupShowMusicalScore ();
	afx_msg void OnUpdatePopupShowMusicalScoreUI (CCmdUI* pCmdUI);
	...
	afx_msg void OnPopupSelectVoice ();
	afx_msg void OnUpdatePopupSelectVoiceUI (CCmdUI* pCmdUI);
	afx_msg void OnPopupLoadSysExData ();
	afx_msg void OnUpdatePopupLoadSysExDataUI (CCmdUI* pCmdUI);
	afx_msg void OnPopupSaveSysExData ();
	afx_msg void OnUpdatePopupSaveSysExDataUI (CCmdUI* pCmdUI);

	afx_msg void OnCommandStopPlaying ();
	afx_msg void OnCommandStopRecording ();
